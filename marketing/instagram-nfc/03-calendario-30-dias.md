...
- Entre semana: **13:00** (hora de almuerzo) o **20:00** (después de la cena).
- Sábado: **11:00**.
- Domingo: solo historias, sin post de feed.

**Formatos:** 🎬 Reel · 🎠 Carrusel · 🖼️ Post simple

| Día | Formato | # | Título | Objetivo |
|---|---|---|---|---|
| **SEMANA 1 — "¿Qué es esto?"** ||||| |
| 1 (Lun) | 🎬 | P01 | El toque que reemplaza la tarjeta de papel | Gancho de apertura, máximo alcance |
| 2 (Mar) | 🎠 | P02 | Qué es una tarjeta NFC (y qué no es) | Educar + desarmar desconfianza |
| 3 (Mié) | — | — | Solo historias: encuesta "¿sabías que tu celular ya lo hace?" | Interacción |
| 4 (Jue) | 🎬 | P03 | ¿Tu celular sirve? Compruébalo en 5 segundos | Resolver la objeción #1 |
| 5 (Vie) | 🎠 | P04 | 100 tarjetas de papel vs. 1 tarjeta NFC | Comparación de costo |
| 6 (Sáb) | 🖼️ | P05 | Presentación: quiénes somos | Confianza, cara de la marca |
| 7 (Dom) | — | — | Solo historias: caja de preguntas | Recolectar dudas reales |
...
| 21 (Dom) | — | — | Solo historias: caja de preguntas #2 | Interacción |
...
| 28 (Dom) | — | — | Solo historias: agradecimiento del primer mes | Comunidad |
| 29 (Lun) | 🎬 | P21 | El error que todos cometen al pedir su tarjeta | Autoridad |
| 30 (Mar) | 🎠 | P22 | Lo que viene + cierre de mes | Cierre y recompra |
...
- **Historias diarias** → `06-historias-y-highlights.md`

## Regla del día 31 en adelante

No empieces un calendario nuevo a ciegas. Al terminar el mes:

1. Mira en Estadísticas los **3 posts con más alcance** y los **3 con más guardados**.
   (Guardados y compartidos importan más que los likes — son la señal que usa el algoritmo.)
2. Repite ese formato y ese tema, con otro ángulo.
3. Los 3 peores: no los repitas, aunque a ti te gusten.

Pásame esos números y te armo el mes 2 sobre datos reales en vez de suposiciones.
